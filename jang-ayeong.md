...
안면 기형을 다루는 또 다른 영화로는 [Wonder(원더)](jeon-eunsu.md) 가 있다. 이 작품은 선천적 안면 기형을 가진 소년 어기가 세상의 편견 속에서 자신을 받아들이는 과정을 그려낸다. 초반부의 음악은 낮고 불안한 현악기와 느린 템포로 그의 두려움을 표현하지만, 후반부로 갈수록 밝은 피아노 선율과 장조 화음이 어우러지며 심리적 회복과 희망을 상징한다. 예를 들어, 어기가 학교 무대에서 마침내 사람들 앞에 서는 장면에서 음악은 따뜻하고 개방된 화성으로 전환되어 ‘자기 수용’의 정점을 이룬다. 이러한 구성은 Phantom(팬텀) 이 비극과 고립을 어둡고 긴장된 음악으로 그리는 것과 대조되며, 두 작품은 음악을 통해 ‘소외된 존재의 내면’을 전혀 다른 정조로 조명한다.
